...
const Contact = forwardRef(({cuteMode}, ref) => {
    ...
    <section ref={ref} className="relative py-36 px-6 max-w-5xl mx-auto">
      ...
      <div className='flex items-center justify-center'>
        {cuteMode && (<img className="absolute z-0 top-1/2 left-1/2 -translate-y-93 -translate-x-50 w-100 h-50" src="assets/paper tape red.png"/>)}
        ...
        {cuteMode && (<img className="absolute w-84 left-1/2 translate-x-[80%] top-1/2 -translate-y-[120%] rotate-225 z-0 animate-[shake_2s_steps(1)_infinite]" src="assets/flower sticker 1.png"/>)}
        {cuteMode && (<img className="absolute w-80 left-1/2 -translate-x-[180%] top-1/2 -translate-y-[120%] rotate-75 z-0 animate-[shake_2s_steps(1)_infinite]" src="assets/flower sticker 2.png"/>)}
      </div>
